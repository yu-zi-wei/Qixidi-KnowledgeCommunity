    ...
    <div class="module-main">
      <div class="dictum-title-cl flex-direction-row">
        <div>
          ...
          <el-button size="medium" round type="primary" @click="$router.push('/dictum')">名言广场</el-button>
        </div>
        <div class="">
        ...
        <div>
          ...
          <el-dropdown size="medium">
            <div class="el-dropdown-link" title="名言管理">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item @click.native="routeUrl('/user_admin/dictum/manage?state=all')">名言管理
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
