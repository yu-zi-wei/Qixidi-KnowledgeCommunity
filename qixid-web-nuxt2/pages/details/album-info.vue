<template>
  <div class="module-main-2">
        ...
        <div>
          <div class="ml-20">
            <div class="font-s-20 font-bold">
              <svg t="1682497983576" class="icon icon-size-32 icon-theme svg-translateY-6" viewBox="0 0 1024 1024" version="1.1"
    ...
    <div class="mt-20">
      <dictumList v-if="!loading" :album-id="info.id"></dictumList>
    </div>
  </div>
</template>
