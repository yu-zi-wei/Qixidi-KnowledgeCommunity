...
<style scoped>
.follow-list-admin {
  background: linear-gradient(90deg, rgba(255, 118, 117, 0.2) 30%, rgba(252, 205, 226, 0.3) 100%);
  border-radius: 10px;
