  ...
  <div class="index-main">
    ...
    <div class="index-right">
      <div :class="{'recommend-article-div-true':positionCssRight,'recommend-article-div-false':!positionCssRight}">
        ...
        <ul class="mt-15 ml-10" v-if="!siteInfoLoading">
          <li title="备案" class="mb-4">
            ...
            <a href="https://beian.miit.gov.cn" class="font-s-13 hover-cl color-grey" target="_blank"
               rel="nofollow">{{ siteInfo.filings }}</a>
          </li>
          <li title="反馈邮箱" class="mb-4">
            <svg t="1720059190371" class="icon icon-size-16 svg-translateY-3-5 mr-2"
              ...
              <path
                ...
                p-id="24832" fill="#ffa502"></path>
            </svg>
            <span class="font-s-13 color-grey">反馈邮箱：{{ siteInfo.mailbox }}</span>
          </li>
          <li title="开源地址" class="mb-4">
            <svg t="1732604112590" class="icon icon-size-16 svg-translateY-3-5 mr-2" viewBox="0 0 1024 1024"
                 version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="4441">
              <path
                ...
                fill="#C71D23" p-id="4442"></path>
            </svg>
            <a href="https://gitee.com/yu-zi-wei/qixidi" target="_blank" class="font-s-13 color-blue text-underline">开源地址：gitee.com</a>
          </li>
          <li class="mb-4">
            ...
            <span class="font-s-13 color-grey">小站已经运行了：<span>{{ siteOperationTime }}</span></span>
          </li>
        </ul>
      </div>
    </div>
