            ...
            <div style="padding: 0 10px ">
              ...
              <el-row :gutter="20" class="mb-20">
                ...
                <span class="font-bold cursor-pointer hover-cl">
                  ...
                  <span class="ml-4 mr-6 color-grey">{{ item.occupation == null ? '职业-~-' : item.occupation }}</span>|
                  <span class="ml-4 color-grey">{{ $utils.parseTime(item.createTime, '{y}-{m}-{d}') }}</span>
                </el-col>
              </el-row>
