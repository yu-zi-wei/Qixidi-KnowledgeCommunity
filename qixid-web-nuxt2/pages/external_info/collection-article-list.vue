...
<!--        <p class="mt-10 font-s-14 text-center color-grey" v-text="collectionInfo.collectionIntroduce"></p>-->
        <el-row>
          <el-col :span="19" class="ml-4 color-grey4">
            <div class="font-s-14 flex-left align-items-center">
              <el-avatar v-if="userinfo.avatar" class="fl-left" :src="userinfo.avatar" :size="50"></el-avatar>
              ...
              <div v-show="!loading">
                <ul class="content" v-if="collectionUserLoading">
                  <li v-for="item of articleList" class="contentItem">
                    ...
                    <div class="abstract-class mt-5" v-text="item.articleAbstract"></div>
                    <div class="font-s-13 color-grey bo-list-loc flex-left">
                      ...
                      <div>
                        ...
                        <span class="ml-4 color-grey-2" v-text="item.commentTimes==0?'评论':item.commentTimes"></span>
                      </div>
                      <div title="文章状态">
                      ...
                      <div v-if="currentUser">
                        <el-dropdown trigger="click">
                          ...
                          <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item @click.native="articleTransfer(item.id,item.collectionId)">转移
                            </el-dropdown-item>
                ...
                <div v-else>
                  <div style="text-align: center;">
                    ...
                    <div class="font-s-12 color-grey">暂无收藏</div>
                  </div>
                </div>
              </div>
            </el-tab-pane>
    ...
    <el-dialog
      ...
      width="30%">
      <div v-for="item of collectionList" class="mt-15 overflow-hidden">
    ...
    <el-button @click="collectionLoading = false">取 消</el-button>
    <el-button type="primary" :loading="buttonCoLoading" @click="transferCollection()">转 移</el-button>
  </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    articleTransfer(id, collectionId) {
