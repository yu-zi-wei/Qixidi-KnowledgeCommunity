  ...
  <div>
    ...
    <ul class="content" v-if="collectionUserLoading" ref="dialogContent" @scroll="divScroll($event)">
      <li v-for="item of articleList" class="contentItem">
        ...
        <nuxt-link class="text-underline-hover font-bold-s" :to="`/article/article-details/`+$base64.encode(item.id)"
        ...
        <div class="font-s-13 color-grey-2 bo-list-loc flex-left">
          ...
          <div title="文章状态" class="mr-4 svg-translateY-2">
          ...
          <div v-if="currentUser" class="svg-translateY-3">
