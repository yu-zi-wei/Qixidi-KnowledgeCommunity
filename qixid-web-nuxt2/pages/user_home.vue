            ...
            <div class="home-left-cl">
              ...
              <div>
                <div class="mb-15">
                  ...
                  <span>文章</span>
                  <span>（{{ userData.articleCount == 0 ? '--' : userData.articleCount }}）</span>
                </div>
                <div class="mb-15">
                  ...
                  <span>随笔</span>
                  <span>（{{ userData.dictumCount == 0 ? '--' : userData.dictumCount }}）</span>
                </div>
                <div class="mb-15">
                  <svg t="1761706928977" class="icon svg-translateY-4 icon-size-20 mr-4" viewBox="0 0 1024 1024"
                       version="1.1"
                       xmlns="http://www.w3.org/2000/svg" p-id="35615">
                    <path
                      d="M168.789333 490.922667h40.362667a40.32 40.32 0 1 1 0 80.554666h-40.362667a40.32 40.32 0 1 1 0-80.554666z m0-241.706667h40.362667a40.32 40.32 0 1 1 0 80.597333h-40.362667a40.32 40.32 0 1 1 0-80.597333z m0 483.413333h40.362667a40.192 40.192 0 1 1 0 80.554667h-40.362667a40.32 40.32 0 1 1 0-80.597333z m20.181334 120.832h20.181333a80.64 80.64 0 0 0 80.768-80.597333 80.64 80.64 0 0 0-80.768-80.554667H189.013333v-80.554666h20.181334a80.64 80.64 0 0 0 80.768-80.554667 80.64 80.64 0 0 0-80.768-80.554667H189.013333V370.090667h20.181334a80.64 80.64 0 0 0 80.768-80.554667 80.64 80.64 0 0 0-80.768-80.597333H189.013333A80.64 80.64 0 0 1 269.738667 128.426667h545.152a80.64 80.64 0 0 1 80.768 80.554666v644.522667a80.64 80.64 0 0 1-80.768 80.554667H269.738667a80.64 80.64 0 0 1-80.768-80.554667zM749.952 332.245333a60.629333 60.629333 0 0 0-85.674667 0L377.514667 618.24a20.138667 20.138667 0 0 0-5.845334 12.8l-4.394666 61.354667a20.096 20.096 0 0 0 21.546666 21.504l61.525334-4.352a20.224 20.224 0 0 0 12.8-5.845334l286.805333-286.037333a60.330667 60.330667 0 0 0 0-85.461333z"
                      fill="#98ACFF" p-id="35616"></path>
                  </svg>
                  <span>小记</span>
                  <span>（{{ userData.timeNotesCount == 0 ? '--' : userData.timeNotesCount }}）</span>
                </div>
                <div class="mb-15">
                  ...
                  <span>专辑</span>
                  <span>（{{ userData.albumCount == 0 ? '--' : userData.albumCount }}）</span>
                </div>
                <div class="mb-15">
                  ...
                  <span>关注Ta</span>
                  <span>（{{ userData.fansFollowCount == 0 ? '--' : userData.fansFollowCount }}）</span>
                </div>
                <div class="mb-15">
                  ...
                  <span>专栏</span>
                  <span>（{{ userData.specialColumnCount == 0 ? '--' : userData.specialColumnCount }}）</span>
                </div>
              </div>
            </div>
          </div>
