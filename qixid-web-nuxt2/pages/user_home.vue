          ...
          <el-col :span="4">
            <div class="home-left-cl">
              ...
              <div class="user-data-cl">
                <p>
                  <svg t="1684217091163" class="icon-theme icon-size-20 svg-translateY-6 mr-4" viewBox="0 0 1024 1024"
                       version="1.1"
                  ...
                  专辑 <span class="font-bold-s ml-4">
                {{ userData.albumCount == 0 ? '--' : userData.albumCount }}
              </span>
                </p>
                <p>
                  <svg t="1684217048924" class="icon-theme icon-size-20 svg-translateY-6 mr-4" viewBox="0 0 1024 1024"
                       version="1.1"
                  ...
                  名言 <span class="font-bold-s ml-4">
                {{ userData.dictumCount == 0 ? '--' : userData.dictumCount }}
              </span>
                </p>
                <p>
                  <svg t="1676383484417" class="icon icon-size-20 svg-translateY-6 mr-4" viewBox="0 0 1024 1024"
                       version="1.1"
                  ...
                  文章<span class="font-bold-s ml-4">
                {{ userData.articleCount == 0 ? '--' : userData.articleCount }}
              </span>
                </p>
                <p>
                  <svg t="1676383543481" class="icon-theme icon-size-20 svg-translateY-5 mr-4" viewBox="0 0 1024 1024"
                       version="1.1"
                  ...
                  关注Ta <span class="font-bold-s ml-4">
                {{ userData.fansFollowCount == 0 ? '--' : userData.fansFollowCount }}
              </span>
                </p>
                <p>
                  <svg t="1676383606938" class="icon icon-size-20 svg-translateY-6 mr-4 " viewBox="0 0 1024 1024"
                       version="1.1"
                    ...
                    <path
                      ...
                      fill="#FFFFFF" p-id="779" data-spm-anchor-id="a313x.7781069.0.i1" class="selected"></path>
                  </svg>
                  专栏 <span class="font-bold-s ml-4">
