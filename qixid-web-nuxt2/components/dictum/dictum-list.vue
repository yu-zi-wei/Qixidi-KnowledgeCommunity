      ...
      <ul v-if="dictumInfoListArr.length>0">
        <li v-for="(item,index) in dictumInfoListArr" class="dictum-info-cl" :key="index">
          ...
          <div class="flex-left font-s-13 color-grey-2 mt-20">
            ...
            <div title="评论" class="cursor-pointer mr-20" @click="$modal.notify('功能待开发！')">
              <svg t="1685704893908" class="icon icon-theme-1 icon-size-16 svg-translateY-3" viewBox="0 0 1024 1024"
                   version="1.1"
