      ...
      <ul v-if="dictumInfoListArr.length>0">
        <li v-for="(item,index) in dictumInfoListArr" class="dictum-info-cl" :key="index">
          <div class="flex-space-between user-info align-items-center">
            ...
            <div class="ml-8">
              <el-tag class="cursor-pointer transform-translateY-hover-2 mr-10" size="small" effect="plain"
                      type="danger" title="收录专辑"
                      v-if="item.albumName!=null">
                {{ item.albumName }}
              </el-tag>
              <span v-if="item.labelList!=null"
                    v-for="(items,indexs) in item.labelList" title="标签" :key="indexs" class="font-s-13 color-theme">
              {{ items }}
          ...
          <div class="flex-left font-s-13 color-grey-2 mt-20">
            <div title="点赞" class="cursor-pointer mr-20 hover-cl" @click="$modal.notify('功能待开发！')">
              <svg t="1685704715311" class="icon icon-size-16 svg-translateY-3" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#ff6348" p-id="2428"></path>
              </svg>
              点赞
            </div>
            <div title="评论" class="cursor-pointer mr-20 hover-cl" @click="$modal.notify('功能待开发！')">
              <svg t="1685704893908" class="icon icon-size-16 svg-translateY-3" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  p-id="3485" fill="#3498db"></path>
              </svg>
              评论
            </div>
            <div title="收藏" class="cursor-pointer mr-20 hover-cl" @click="$modal.notify('功能待开发！')">
