        ...
        <div class="main-nav">
          ...
          <div class="nav-list">
            ...
            <ul class="nav-right-ul">
              ...
              <!--        创作中心-->
              <li>
                <el-dropdown class="el-dropdown-link ml-15" title="创作中心">
                  <div class="mt-4">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <div class="flex-left" style="margin: 2px 15px">
                      <div class="publish-list-item text-center" @click="publishData('/article/publish-article')">
                        ...
                        <p class="font-s-14 line-height-18">写文章</p>
                      </div>

                      <div class="publish-list-item text-center ml-20"
                           @click="routeJumpUrl('/dictum/release-dictum')">
                        <svg t="1735805532099" class="icon" viewBox="0 0 1024 1024" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" p-id="30600" width="30" height="30">
                          <path
                            fill="#6c5ce7"
                        ...
                        <p class="font-s-14 line-height-18">记名言</p>
                      </div>
                    </div>
                  </el-dropdown-menu>
                </el-dropdown>
