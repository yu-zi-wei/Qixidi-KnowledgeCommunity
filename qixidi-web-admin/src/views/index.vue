<template>
  <div class="index-admin">
    <el-card class="box-card text-center mb-20">
      <span class="font-s-24 font-bold color-blue">栖息地后台数据统计</span>
    </el-card>
    <!--    一  -->
    <el-row>
      <el-col :span="4">
        <el-tooltip placement="top-end" effect="light">
          <div slot="content">统计时间：<span class="color-huang">{{ statInfos.statTime }}</span>
            <br/>用户总数：<span class="color-blue">{{ statInfos.userCount == null ? '--' : statInfos.userCount }}</span>
          </div>
          <el-card class="box-card font-s-18 text-center">
            <p class="color-blue font-s-24 font-bold">{{ statInfos.userCount == null ? '--' : statInfos.userCount }}</p>
            <div>
              <svg t="1678882513407" class="icon svg-text-center-32-f mr-6" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#FF9000" p-id="8252"></path>
              </svg>
              <span class="font-bold cursor-pointer text-underline-hover"
                    @click="$router.push('/system/userMain/main')">用户总数</span>
        ...
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">统计时间：<span class="color-huang">{{ statInfos.statTime }}</span>
            <br/>用户在线总数：<span class="color-blue">{{
                statInfos.onlineUserCount == null ? '--' : statInfos.onlineUserCount
              }}</span>
          </div>
          <el-card class="box-card font-s-18 text-center">
            <p class="color-blue font-s-24 font-bold">
        ...
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">名言分类总数：<span class="color-blue">{{
        ...
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">名言专辑总数：<span class="color-blue">{{
            ...
            <div>
              <svg t="1683610008410" class="icon svg-text-center-32-f mr-6" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#FFAF50" p-id="3159"></path>
              </svg>

              <span class="font-bold cursor-pointer text-underline-hover"
                    @click="$router.push('/dicum/album')">名言专辑总数</span>
            </div>
          </el-card>
        </el-tooltip>
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">名言总数：<span class="color-blue">{{
            ...
            <div>
              <svg t="1683610040603" class="icon svg-text-center-32-f mr-6" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#8e44ad" p-id="3765"></path>
              </svg>
              <span class="font-bold cursor-pointer text-underline-hover"
                    @click="$router.push('/dicum/info')">名言总数</span>
            </div>
          </el-card>
        </el-tooltip>
      </el-col>
      ...
      <el-col :span="4">
            ...
            <div>
              <svg t="1678883495542" class="icon svg-text-center-32-f mr-6" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#FFFFFF" p-id="15617"></path>
              </svg>
              <span class="font-bold cursor-pointer text-underline-hover"
                    @click="$router.push('/article/article-inform')">文章总数</span>
            </div>
          </el-card>
        </el-tooltip>
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">统计时间：<span class="color-huang">{{ statInfos.statTime }}</span>
            <br/>专栏总数：<span class="color-blue">{{
            ...
            <div>
              <svg t="1678883217420" class="icon svg-text-center-32-f mr-6" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#6b0d64" p-id="10317"></path>
              </svg>
              <span class="font-bold cursor-pointer text-underline-hover" @click="$router.push('/special/information')">专栏总数</span>
            </div>
          </el-card>
        </el-tooltip>
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">统计时间：<span class="color-huang">{{ statInfos.statTime }}</span>
            <br/>收藏夹总数：<span class="color-blue">{{
            ...
            <div>
              <svg t="1678883310365" class="icon svg-text-center-32-f mr-6" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#FFFFFF" p-id="11522"></path>
              </svg>
              <span class="font-bold cursor-pointer text-underline-hover"
                    @click="$router.push('/collection/information')">收藏夹总数</span>
            </div>
          </el-card>
        </el-tooltip>
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">标签分类总数：<span class="color-blue">{{
        ...
        <el-tooltip placement="top-end" effect="light" class="mt-20">
          <div slot="content">标签总数：<span class="color-blue">{{
            ...
            <div>
              <svg t="1678883431292" class="icon svg-text-center-32-f mr-6" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#f19610" p-id="14551"></path>
              </svg>
              <span class="font-bold cursor-pointer text-underline-hover"
                    @click="$router.push('/label/info')">标签总数</span>
            </div>
          </el-card>
        </el-tooltip>
      </el-col>
...
<script>
import {statInfo, statTheInfo, labelDate} from "@/api/business/statInfo";
