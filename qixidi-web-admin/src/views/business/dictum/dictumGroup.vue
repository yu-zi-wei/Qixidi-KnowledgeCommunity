    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:dictum:group:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['business:dictum:group:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:dictum:group:export']"
        >导出
        </el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['business:dictum:group:edit']"
          >修改
          </el-button>
          <el-button
            size="mini"
...
<script>
import {listGroup, getGroup, delGroup, addGroup, updateGroup} from "@/api/business/dictum/dictumGroup";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除名言分组编号为"' + ids + '"的数据项？').then(() => {
        this.loading = true;
        return delGroup(ids);
      }).then(() => {
        this.loading = false;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/business/dictum/group/export', {
        ...this.queryParams
