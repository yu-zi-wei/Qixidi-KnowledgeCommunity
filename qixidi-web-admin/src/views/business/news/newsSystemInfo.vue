<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否有详情" prop="isDetails">
        <el-input
          v-model="queryParams.isDetails"
          placeholder="请输入是否有详情"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="失效时间" prop="lapseTime">
        <el-date-picker clearable
                        v-model="queryParams.lapseTime"
                        type="date"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:news:systemInfo:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['business:news:systemInfo:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['business:news:systemInfo:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:news:systemInfo:export']"
        >导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="systemInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否有详情" align="center" prop="isDetails"/>
      <el-table-column label="消息类型" align="center" prop="type"/>
      <el-table-column label="失效时间" align="center" prop="lapseTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.lapseTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否有详情" prop="isDetails">
          <el-input v-model="form.isDetails" placeholder="请输入是否有详情"/>
        </el-form-item>
        <el-form-item label="失效时间" prop="lapseTime">
          <el-date-picker clearable
                          v-model="form.lapseTime"
                          type="datetime"
...
import {
  ...
  addSystemInfo,
  updateSystemInfo
} from "@/api/business/newsSystemInfo";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        isDetails: [
          {required: true, message: "是否有详情不能为空", trigger: "blur"}
        ],
        type: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除系统消息编号为"' + ids + '"的数据项？').then(() => {
        this.loading = true;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/business/news/systemInfo/export', {
        ...this.queryParams
