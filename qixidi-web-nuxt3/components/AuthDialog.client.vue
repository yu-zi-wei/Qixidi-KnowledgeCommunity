    ...
    <div class="auth-dialog">
      ...
      <div class="auth-aside">
        <div class="aside-content">
          <div class="aside-icon">栖</div>
          <h2 class="aside-title">栖息地</h2>
...
const viewTitle = computed(() => {
  const map = { login: '欢迎回来', register: '加入栖息地', reset: '找回密码' }
  return map[currentView.value]
})

const viewSubtitle = computed(() => {
  const map = { login: '登录您的账号以继续', register: '创建您的栖息地账号', reset: '重置您的密码' }
  return map[currentView.value]
})
