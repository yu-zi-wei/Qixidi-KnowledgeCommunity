...
public interface ISpecialInformationService {
    ...
    List<SpecialInformationVo> specialListUid(SpecialInformationBo bo);

    List<SpecialInformationVo> specialList();

    List<ArticleInformationVo> selectSpecial(SpecialInformationBo bo, PageQuery pageQuery);
    ...
    List<CensusVo> submissionCensus();
