package com.qixidi.auth.manager;
...
import com.qixidi.auth.service.SysBlackListService;
...
public class SysBlackListManager {
    ...
    public void loadData() {
        blackListLokuro();//落库
        List<SysBlackList> sysBlackLists = sysBlackListService.list(new QueryWrapper<>());
