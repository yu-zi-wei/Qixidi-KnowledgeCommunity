<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="分组id" prop="labelGroupingId">
        <el-input
          v-model="queryParams.labelGroupingId"
          placeholder="请输入分组id"
          clearable
      ...
      <el-form-item label="描述" prop="labelDescribe">
        <el-input
          v-model="queryParams.labelDescribe"
          placeholder="请输入描述"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="封面" prop="labelCover">
        <el-input
          v-model="queryParams.labelCover"
          placeholder="请输入封面"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分组id" align="center" prop="labelGroupingId" />
      <el-table-column label="名称" align="center" prop="labelName" />
      <el-table-column label="描述" align="center" prop="labelDescribe" />
      <el-table-column label="封面" align="center" prop="labelCover" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="分组id" prop="labelGroupingId">
          <el-input v-model="form.labelGroupingId" placeholder="请输入分组id" />
        </el-form-item>
        <el-form-item label="名称" prop="labelName">
