<template>
  <div class="mt-20 mb-40">
    ...
    <a-spin :loading="loading" tip="正在赶来的路上..." style="width: 100%;" :size="28">
      ...
      <div v-if="!listInfoData.content && !listInfoData.title && !loading" class="text-center"
           style="color: #fefefe;font-size: 18px">
...
<script>
import {listAbout} from "@/api/lover";
...
export default {
  ...
  methods: {
    listAbouts() {
      listAbout().then(res => {
        this.listInfoData.content = res.content
        this.listInfoData.title = res.title
        this.loading = false;
      })
    }
  },
